/**
* Class that display that display the information like menu, the word to guess
* and that check if the user is guessing the missing leters.
*/
...
public class Game {
	...
	/**
	*Chooses a random word from the array wordForGuesing
	*/
